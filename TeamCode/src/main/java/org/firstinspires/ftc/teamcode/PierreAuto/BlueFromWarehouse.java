...
@Autonomous(name = "!!AUTO FINAL", group = "!Primary")
public class BlueFromWarehouse extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rb.RFmotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        rb.RBmotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        rb.LFmotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        rb.LBmotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        ...
        */
        ...
        //while (rb.shippingSensor.getDistance(DistanceUnit.MM) > 20 && timeBeforeWhile2 + 500 > runtime.milliseconds()){
        //    rb.strafe(.3);
        //}
        rb.strafe(-.3);
        sleep(50);
        ...
        sleep(2000);
        timeBeforeWhile2 = runtime.milliseconds();
        while (rb.shippingSensor.getDistance(DistanceUnit.MM) > 7 && timeBeforeWhile2 + 475 > runtime.milliseconds()){
            rb.drive(.3);
        }
